    ...
    >
      ...
      <Card style={styles.dateCard}>
        <View style={styles.dateInfo}>
          ...
          {isWeekend && <Text style={styles.weekendNote}>Weekend - No attendance required</Text>}
        </View>
      </Card>
        ...
        {todayAttendance ? (
          <View style={styles.attendanceMarked}>
            <View style={[styles.statusBadge, styles.present]}>
              <Text style={[styles.statusText, styles.presentText]}>PRESENT</Text>
            </View>
            <Text style={styles.markedTime}>
              Marked at: {todayAttendance.timestamp?.toDate?.()?.toLocaleTimeString() || "Unknown time"}
            </Text>
            <Text style={styles.successMessage}>✓ Your attendance has been recorded for today</Text>
          </View>
        ) : (
          <View style={styles.attendanceNotMarked}>
            <View style={[styles.statusBadge, styles.absent]}>
              <Text style={[styles.statusText, styles.absentText]}>NOT MARKED</Text>
            </View>
            <Text style={styles.pendingMessage}>Please mark your attendance for today</Text>
      ...
      {!todayAttendance && !isWeekend && (
        <Card style={styles.instructionsCard}>
          ...
          <View style={styles.instructionsList}>
            <Text style={styles.instructionItem}>1. Tap the "Mark Attendance" button</Text>
            <Text style={styles.instructionItem}>2. Authenticate using your fingerprint</Text>
            <Text style={styles.instructionItem}>3. Your attendance will be recorded automatically</Text>
          </View>
        </Card>
      )}
      ...
      {isWeekend && (
        <Card style={styles.weekendCard}>
          ...
          <Text style={styles.weekendMessage}>Enjoy your weekend! Attendance marking is not required on weekends.</Text>
        </Card>
      )}
    </ScrollView>
  )
